    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.IntegerField(blank=True, choices=[(1, '男'), (2, '女'), (3, '未知')], null=True, verbose_name='性别')),
                ('address', models.CharField(blank=True, max_length=350, null=True, verbose_name='地址')),
                ('power', models.IntegerField(choices=[(1, '普通用户'), (3, '管理员')], default=1, verbose_name='用户类别')),
